...
def process_files(files, start_year, end_year):
    ...
    reporter_cands = ['reporter', 'exporter', 'reporteriso3', 'exporteriso3']
    partner_cands = ['partner', 'importer', 'partneriso3', 'importeriso3']
    product_cands = ['product code', 'commodity code', 'productcode', 'hs code', 'commodity']
    year_cands = ['year']
    value_cands = ['trade value', 'tradevalue', 'export (us$ thousand)', 'value']
